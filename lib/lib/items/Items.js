...
var Items = function (_Component) {
  ...
  _createClass(Items, [{
    ...
    value: function __itemDrop__REACT_HOT_LOADER__(itemId, dragTimeDelta, oldGroupOrder, dragGroupDelta) {
      ...
      this.props.selectedItems.forEach(function (selectedItemId) {
        ...
        _this4.props.itemDrop(selectedItemId, (0, _generic._get)(item, itemTimeStartKey) + dragTimeDelta, order, dragGroupDelta);
      });
