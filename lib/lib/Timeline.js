...
var _initialiseProps = function _initialiseProps() {
  ...
  this.updateScrollCanvas = function (visibleTimeStart, visibleTimeEnd, forceUpdateDimensions, updatedItems, updatedGroups) {
    ...
    if (canKeepCanvas) {
      ...
      if (_this5.scrollComponent.scrollLeft !== newScrollLeft) {
        resetCanvas = true;
      }
    } else {
      resetCanvas = true;
  ...
  this.onWheel = function (e) {
    var traditionalZoom = _this5.props.traditionalZoom;
  ...
  this.itemDrop = function (itemId, dragTime, oldGroupOrder, dragGroupDelta) {
    var indexNewGroup = oldGroupOrder + dragGroupDelta;
    if (indexNewGroup > _this5.props.groups.length - 1) {
      indexNewGroup = _this5.props.groups.length - 1;
    }
    if (indexNewGroup < 0) {
      indexNewGroup = 0;
    }
    ...
    if (_this5.props.onItemMove) {
      _this5.props.onItemMove(itemId, dragTime, indexNewGroup);
    }
  };
